...
curl -X POST -d 'data=%7B%22name%22%3A%22emmanuel%22%2C%22email%22%3A%22emailemmanuel%40gmail.com%22%2C%22password%22%3A%22hello%22%7D' -H 'Content-Type: application/x-www-form-urlencoded' http://localhost:3000/api/users
echo ""
#login du compte emmanuel
curl -X POST -d 'data=%7B%22name%22%3A%22emmanuel%22%2C%22email%22%3A%22emailemmanuel%40gmail.com%22%2C%22password%22%3A%22hello%22%7D' -H 'Content-Type: application/x-www-form-urlencoded' http://localhost:3000/api/login
echo ""
...
curl -X POST -d 'data=%7B%22name%22%3A%22mouahe%22%2C%22email%22%3A%22emailmouahe%40gmail.com%22%2C%22password%22%3A%22hello%22%7D' -H 'Content-Type: application/x-www-form-urlencoded' http://localhost:3000/api/users
echo ""
#login du compte mouahe
curl -X POST -d 'data=%7B%22name%22%3A%22mouahe%22%2C%22email%22%3A%22emailmouahe%40gmail.com%22%2C%22password%22%3A%22hello%22%7D' -H 'Content-Type: application/x-www-form-urlencoded' http://localhost:3000/api/login
echo ""
...
curl -X POST -d 'data=%7B%22name%22%3A%22jackson%22%2C%22email%22%3A%22emailjackson%40gmail.com%22%2C%22password%22%3A%22hello%22%7D' -H 'Content-Type: application/x-www-form-urlencoded' http://localhost:3000/api/users
echo ""
#login du compte jackson
curl -X POST -d 'data=%7B%22name%22%3A%22jackson%22%2C%22email%22%3A%22emailjackson%40gmail.com%22%2C%22password%22%3A%22hello%22%7D' -H 'Content-Type: application/x-www-form-urlencoded' http://localhost:3000/api/login
echo ""
echo "The game ID is: $game_id"
curl -X POST \
